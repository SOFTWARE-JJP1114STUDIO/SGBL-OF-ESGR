...
<head>
    ...
    <title>Système de gestion de bibliothèque en ligne | Modification du mot de passe de l'utilisateur admin</title>
...
<div class="col-md-12">
<h4 class="header-line">Modification du mot de passe de l'utilisateur</h4>
</div>
</div>
...
<input class="form-control"  type="password" name="confirmpassword" autocomplete="off" required  />
 ...
 <button type="submit" name="change" class="btn btn-info">Modifier le mot de passe </button> 
</form>
 </div>
</div>
</div>
