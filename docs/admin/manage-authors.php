...
<head>
    ...
    <title>Système de gestion de bibliothèque en ligne | Gérer les auteurs</title>
...
{               ?>                                      
                                        <tr class="odd gradeX">
                                          ...
                                          <a href="manage-authors.php?del=<?php echo htmlentities($result->id);?>" onclick="return confirm('Êtes-vous sûr de vouloir effacer ?');"" >  <button class="btn btn-danger"><i class="fa fa-pencil"></i> Supprimer</button>
                                            </td>
                                        </tr>
 <?php $cnt=$cnt+1;}} ?>                                      
                                    </tbody>
