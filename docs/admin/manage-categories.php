...
<head>
    ...
    <title>Système de gestion de bibliothèque en ligne | Gérer les catégories</title>
...
{               ?>                                      
                                        <tr class="odd gradeX">
                                            ...
                                            <a href="edit-category.php?catid=<?php echo htmlentities($result->id);?>"><button class="btn btn-primary"><i class="fa fa-edit "></i> Editer</button> 
                                          <a href="manage-categories.php?del=<?php echo htmlentities($result->id);?>" onclick="return confirm('Êtes-vous sûr de vouloir effacer ?');"" >  <button class="btn btn-danger"><i class="fa fa-pencil"></i> Supprimer</button>
                                            </td>
                                        </tr>
 <?php $cnt=$cnt+1;}} ?>                                      
                                    </tbody>
