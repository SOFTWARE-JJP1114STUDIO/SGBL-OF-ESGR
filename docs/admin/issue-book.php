...
<head>
    ...
    <title>Système de gestion de bibliothèque en ligne | Faire l'emprunt d'un livre</title>
...
<!-- MENU SECTION END-->
    ...
    <div class="content-wrapper">
        ...
        <div class="row pad-botm">
            <div class="col-md-12">
                <h4 class="header-line">Faire l'emprunt d'un livre</h4>
...
Faire l'emprunt d'un livre
</div>
<div class="panel-body">
<form role="form" method="post">

<div class="form-group">
<label>Numéro d'identification de l'étudiant<span style="color:red;">*</span></label>
...
<button type="submit" name="issue" id="submit" class="btn btn-info">Confirmer l'emprunt </button>
