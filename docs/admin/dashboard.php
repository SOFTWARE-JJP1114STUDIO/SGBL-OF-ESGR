...
<head>
    ...
    <!--[if IE]>
        ...
        <![endif]-->
    <title>Système de gestion de bibliothèque en ligne | Tableau de bord de l'administrateur</title>
...
<!-- MENU SECTION END-->
    <div class="content-wrapper">
        ...
        <div class="row pad-botm">
            <div class="col-md-12">
                <h4 class="header-line">TABLEAU DE BORD ADMINISTRATIF</h4>
             ...
             <div class="row">
              ...
              <div class="col-md-3 col-sm-3 col-xs-6">
                  <div class="alert alert-success back-widget-set text-center">
                      <a href="manage-books.php"><!-- Ajoutez le lien que vous souhaitez ici -->
                          <img src="https://cdn-icons-png.freepik.com/512/5597/5597125.png?ga=GA1.1.107990814.1707072978&" alt style="width: 65%">
                      </a>
                      <?php 
               ...
               <div class="col-md-3 col-sm-3 col-xs-6">
                      <div class="alert alert-danger back-widget-set text-center">
                        <a href="reg-students.php">
                          <img src="https://cdn-icons-png.freepik.com/512/5597/5597017.png" alt style="width: 67%">
                        </a>
                            <?php 
 ...
 <div class="col-md-3 col-sm-3 col-xs-6">
                      <div class="alert alert-success back-widget-set text-center">
                        <a href="manage-authors.php">
                          <img src="https://cdn-icons-png.freepik.com/512/5597/5597098.png" alt style="width: 67%">
                        </a>
<?php 
                 ...
                 <div class="col-md-3 col-sm-3 rscol-xs-6">
                      <div class="alert alert-info back-widget-set text-center">
                        <a href="manage-categories.php">
                          <img src="https://cdn-icons-png.freepik.com/512/5597/5597140.png" alt style="width: 67%">
                        </a>
<?php 
