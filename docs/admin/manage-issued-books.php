...
<head>
    ...
    <title>Système de gestion de bibliothèque en ligne | Gestion des livres en circulation</title>
...
<!-- MENU SECTION END-->
    <div class="content-wrapper">
        ...
        <div class="row pad-botm">
            <div class="col-md-12">
                <h4 class="header-line">Gérer les livres en circulation</h4>
    </div>
     <div class="row">
                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tbody>
<?php $sql = "SELECT tblstudents.FullName,tblbooks.BookName,tblbooks.Tome,tblbooks.Serie,tblissuedbookdetails.IssuesDate,tblissuedbookdetails.ReturnDate,tblissuedbookdetails.id as rid from  tblissuedbookdetails join tblstudents on tblstudents.StudentId=tblissuedbookdetails.StudentId join tblbooks on tblbooks.id=tblissuedbookdetails.BookId order by tblissuedbookdetails.id desc";
...
{               ?>                                      
                                        <tr class="odd gradeX">
                                            ...
                                            {
                                                echo htmlentities("Pas de retour pour le moment");
                                            } else {
                                            ...
                                            <a href="update-issue-bookdeails.php?rid=<?php echo htmlentities($result->rid);?>"><button class="btn btn-primary"><i class="fa fa-edit "></i> Editer</button> 
